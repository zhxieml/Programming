...
{
    int m = obj.month, d = obj.day, y = obj.year;
    cout << "Please input the number of month, day and year:";
...
{
    if ((month <= 0 || month > 12) || ((day <= 0) || (isLeap() && day > leapMonth[month - 1]) || (!isLeap() && day > normalMonth[month - 1]))) return false;
    else return true;
}
